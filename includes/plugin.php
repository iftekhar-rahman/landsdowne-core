...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Landsdowne_Addon\Plugin The single instance of the class.
	 */
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'landsdowne-css', plugins_url( '/assets/css/landsdowne.css', __FILE__ ) );

		wp_enqueue_style( 'swiper-bundle' );
		wp_enqueue_style( 'landsdowne-css' );
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'landsdowne',
			[
				'title' => esc_html__( 'Landsdowne Dental', 'landsdowne-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/landsdowne-socials.php' );
		require_once( __DIR__ . '/widgets/header-contact.php' );
		require_once( __DIR__ . '/widgets/testimonial.php' );

		$widgets_manager->register( new \Landsdowne_Addon\Landsdowne_Socials() );
		$widgets_manager->register( new \Landsdowne_Addon\Landsdowne_Header_Contact() );
		$widgets_manager->register( new \Landsdowne_Addon\Testimonials() );
